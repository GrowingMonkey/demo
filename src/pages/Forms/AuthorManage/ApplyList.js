  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        return (
          <Fragment>
            <a onClick={() => this.handleUpdateModalVisible(1, record)}>确认</a>
            <Divider type="vertical" />
            <a onClick={() => this.handleUpdateModalVisible(2, record)}>忽略</a>
            <Divider type="vertical" />
            <a onClick={() => this.handleUpdateModalVisible(3, record)}>删除</a>
          </Fragment>
        );
      },
    },
