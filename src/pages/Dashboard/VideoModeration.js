...
import { originUrl, imgUrl } from '@/utils/utils';
...
@connect(({ allvideo, loading }) => ({
  allvideo,
  loading: loading.models.allvideo,
}))
@Form.create()
class Videos extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      render: val => (
        ...
        >
          <img src={`${imgUrl}/${val}`} style={{ width: '100%' }} />
          <div
            style={{
              width: 0,
              height: 0,
              borderLeft: '45px solid #fff',
  ...
  handleUpdateModalVisible = (flag, record) => {
    ...
    router.push(`/dashboard/commondetail/${record.id}?type=videos`);
  };
