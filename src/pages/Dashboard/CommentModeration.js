...
@connect(({ allcomment, loading }) => ({
  allcomment,
  loading: loading.models.allcomment,
}))
@Form.create()
class Comments extends PureComponent {
  ...
  handleUpdateModalVisible = record => {
    ...
    router.push(`/dashboard/commondetail/${record.opusId}?type=comments&opusType=${type}`);
  };
