export default {
  ...
  'validation.comname.required': '请输入公司名称',
  'validation.bannername.required': '请输入广告名称',
  'validation.bannertype.required': '请选择广告类型',
  'validation.bannertype.required': '请输入广告地址',
  'validation.bannerloc.required': '请选择广告位置',
